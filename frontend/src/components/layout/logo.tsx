  ...
  return (
    <span className={cn("flex items-center gap-2.5", className)}>
      <svg viewBox="0 0 32 32" className="size-8" aria-hidden="true">
        <defs>
          <linearGradient id={light ? "flowdesk-mark-light" : "flowdesk-mark"} x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor={light ? "#ffffff" : "var(--color-brand-500)"} />
            <stop offset="100%" stopColor={light ? "#ffe4e6" : "var(--color-brand-700)"} />
          </linearGradient>
        </defs>
        <path d="M16 2 30 29H21.5L16 17.2 10.5 29H2Z" fill={`url(#${light ? "flowdesk-mark-light" : "flowdesk-mark"})`} />
        <path
