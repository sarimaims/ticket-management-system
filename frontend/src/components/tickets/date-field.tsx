  ...
  return (
    <div
      className={cn(
        ...
        bare
          ? "h-full px-1"
          : "h-11 rounded-field border border-line-strong bg-surface px-4 transition-colors focus-within:border-brand-400 focus-within:ring-4 focus-within:ring-brand-500/10",
