  ...
  return (
    <div ref={root} className="relative">
      <button
        ...
        aria-expanded={open}
        className={cn(
          "flex min-h-8 w-full items-center gap-2 rounded-md border bg-surface px-2.5 py-1 text-left transition-colors",
            ...
            return (
              <li key={option.value}>
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left text-[13px] text-ink-700 transition-colors hover:bg-ink-50"
                >
                  <span
                    className={cn(
