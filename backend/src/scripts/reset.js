/**
 * Wipes the workspace back to a bare super admin: every department, ticket and
 * account goes, along with the ticket numbering, so the next ticket is TK-0001
 * again. The super admin account (and its password) is the only thing kept.
 *
 *   npm run reset
 *
